...
public class NewThread implements Runnable{
    ...
    public NewThread(Socket socket, String command) {
        this.socket = socket;
...
//<ESC>%-12345X
    public boolean doWrite(OutputStream out){
        ...
        try {
            ...
            out.write("@PJL COMMENT **Beginning of Job **  \r\n".getBytes());
            out.write("@PJL JOB NAME = \"TF’s Monitor Job\r\n\"".getBytes());
            ...
            out.write(27); //esc
            out.write("%-12345X@PJL\r\n".getBytes());
            out.write("@PJL EOJ NAME = \"End of TF’s Job\" \r\n".getBytes());
            out.write(27); //esc
            out.write("%-12345X".getBytes());
            out.flush();
            //out.close();
